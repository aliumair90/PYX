    ...
    <>
      ...
      <div className="relative min-h-screen flex w-[90%] pl-20 mt-20  mx-auto">
        <div className="absolute flex justify-center items-center h-screen">
          <div className="w-[35%] max-sm:w-[100%] sm:w-[100%] md:w-[35%] z-10 bg-white text-black p-4 mt-[120px]">
        ...
        <div className="absolute left-10 top-0  w-40 h-[375px] z-0 bg-yellow-500"></div>
      ...
      <div className="relative min-h-screen flex w-[90%] pl-20 mt-20  mx-auto">
        ...
        <div className="absolute left-10  w-[500px] h-[375px] z-0 bg-yellow-500"></div>
      ...
      <div className="relative min-h-screen flex w-[90%] pl-20 mt-20 mx-auto">
        <div className="absolute right-[25%] flex justify-center items-center h-screen">
          <div className="w-[50%] z-10 bg-white text-black p-4 mt-[120px]">
            <p className="border-yellow-500 border-2 py-10 px-5 text-center">
              ...
              <button className="bg-black text-white px-4 py-2 rounded-lg mt-5 uppercase">
                Schedule a tour
              </button>
            </p>
          </div>
        ...
        <div className="absolute right-0 top-0  w-40 h-[300px] z-0 bg-yellow-500"></div>
